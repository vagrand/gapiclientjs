...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GenericApi.EventApi();
  });
  ...
  describe('EventApi', function() {
    describe('eventsQueueSettings', function() {
      it('should call eventsQueueSettings successfully', function(done) {
        //uncomment below and update the code to test eventsQueueSettings
        //instance.eventsQueueSettings(function(error) {
