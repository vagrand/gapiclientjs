...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GenericApi.ApiErrorResponse();
  });
  ...
  describe('ApiErrorResponse', function() {
    it('should create an instance of ApiErrorResponse', function() {
      // uncomment below and update the code to test ApiErrorResponse
      //var instane = new GenericApi.ApiErrorResponse();
      //expect(instance).to.be.a(GenericApi.ApiErrorResponse);
    });
