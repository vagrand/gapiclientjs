...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GenericApi.PaginationResponce();
  });
  ...
  describe('PaginationResponce', function() {
    it('should create an instance of PaginationResponce', function() {
      // uncomment below and update the code to test PaginationResponce
      //var instane = new GenericApi.PaginationResponce();
      //expect(instance).to.be.a(GenericApi.PaginationResponce);
    });
