...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GenericApi.QueueSettingsQueue();
  });
  ...
  describe('QueueSettingsQueue', function() {
    it('should create an instance of QueueSettingsQueue', function() {
      // uncomment below and update the code to test QueueSettingsQueue
      //var instane = new GenericApi.QueueSettingsQueue();
      //expect(instance).to.be.a(GenericApi.QueueSettingsQueue);
    });
    ...
    it('should have the property routingKey (base name: "routing_key")', function() {
