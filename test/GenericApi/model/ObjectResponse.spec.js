...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GenericApi.ObjectResponse();
  });
  ...
  describe('ObjectResponse', function() {
    it('should create an instance of ObjectResponse', function() {
      // uncomment below and update the code to test ObjectResponse
      //var instane = new GenericApi.ObjectResponse();
      //expect(instance).to.be.a(GenericApi.ObjectResponse);
    });
