...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GenericApi.PaginationRequest();
  });
  ...
  describe('PaginationRequest', function() {
    it('should create an instance of PaginationRequest', function() {
      // uncomment below and update the code to test PaginationRequest
      //var instane = new GenericApi.PaginationRequest();
      //expect(instance).to.be.a(GenericApi.PaginationRequest);
    });
