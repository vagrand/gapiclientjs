...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GenericApi.InlineObject1();
  });
  ...
  describe('InlineObject1', function() {
    it('should create an instance of InlineObject1', function() {
      ...
      //var instane = new GenericApi.InlineObject1();
      //expect(instance).to.be.a(GenericApi.InlineObject1);
    });
    ...
    it('should have the property markOnly (base name: "mark_only")', function() {
      // uncomment below and update the code to test the property markOnly
      //var instane = new GenericApi.InlineObject1();
      //expect(instance).to.be();
    });
