...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GenericApi.InventoryItemFull();
  });
  ...
  describe('InventoryItemFull', function() {
    it('should create an instance of InventoryItemFull', function() {
      // uncomment below and update the code to test InventoryItemFull
      //var instane = new GenericApi.InventoryItemFull();
      //expect(instance).to.be.a(GenericApi.InventoryItemFull);
    });
    ...
    it('should have the property valueTitle (base name: "value_title")', function() {
      // uncomment below and update the code to test the property valueTitle
      //var instane = new GenericApi.InventoryItemFull();
      //expect(instance).to.be();
    });
