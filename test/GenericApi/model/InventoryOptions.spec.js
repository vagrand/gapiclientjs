...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GenericApi.InventoryOptions();
  });
  ...
  describe('InventoryOptions', function() {
    it('should create an instance of InventoryOptions', function() {
      // uncomment below and update the code to test InventoryOptions
      //var instane = new GenericApi.InventoryOptions();
      //expect(instance).to.be.a(GenericApi.InventoryOptions);
    });
