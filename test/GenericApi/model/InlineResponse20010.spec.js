...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GenericApi.InlineResponse20010();
  });
  ...
  describe('InlineResponse20010', function() {
    it('should create an instance of InlineResponse20010', function() {
      ...
      //var instane = new GenericApi.InlineResponse20010();
      //expect(instance).to.be.a(GenericApi.InlineResponse20010);
    });
    ...
    it('should have the property lastValues (base name: "last_values")', function() {
      // uncomment below and update the code to test the property lastValues
      //var instane = new GenericApi.InlineResponse20010();
      //expect(instance).to.be();
    });
